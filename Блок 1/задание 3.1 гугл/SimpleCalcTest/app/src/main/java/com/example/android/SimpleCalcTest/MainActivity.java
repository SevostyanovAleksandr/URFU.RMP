...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Инициализируйте класс calculator и все представления.
    ...
    /**
     * Метод OnClick вызывается при нажатии кнопки добавить.
     */
    ...
    /**
     * Метод OnClick вызывается при нажатии кнопки разделения.
     */

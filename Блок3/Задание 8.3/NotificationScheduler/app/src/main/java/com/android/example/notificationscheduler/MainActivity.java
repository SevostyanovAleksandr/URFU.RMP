...
public class MainActivity extends AppCompatActivity {
    ...
    // Переключатели для настройки параметров задания.
    private Switch mDeviceIdleSwitch;
    private Switch mDeviceChargingSwitch;

    // Переопределить панель поиска крайнего срока.
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Обновляет текстовое представление значением из панели поиска.
    ...
    /**
     * Метод onClick, который планирует задания на основе заданных параметров.
     */
    ...
    /**
     * Метод onClick для отмены всех существующих заданий.
     */
